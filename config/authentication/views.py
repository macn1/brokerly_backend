...
from .serializer import UserRegisterSerializer ,MyTokenObtainPairSerializer,VendorRegisterSerializer,VendorLoginSerializer,UniversalLoginSerializer,VendorListSerializer
